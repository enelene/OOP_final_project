...
<body class="d-flex h-100 text-center text-bg-dark" data-new-gr-c-s-check-loaded="14.1184.0" data-gr-ext-installed="">
  ...
  <header class="mb-auto">
    <div>
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">
        ...
        <a href="/QuizWebsite/homepage/homepage.jsp">Home</a>
